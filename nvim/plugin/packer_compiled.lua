...
_G.packer_plugins = {
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-ts-autotag", "playground", "nvim-ts-rainbow" },
  ...
  ["nvim-ts-rainbow"] = {
    ...
    loaded = true,
    needs_bufread = false,
    path = "/home/albert/.local/share/nvim/site/pack/packer/opt/nvim-ts-rainbow",
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'git-messenger.vim', 'gitsigns.nvim', 'indent-blankline.nvim', 'null-ls.nvim', 'Comment.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
